<html lang="en">
  ...
  <body>
    ...
    <section id="about">
      <div class="about-wrapper container">
        <div class="about-text">
          ...
          <p>
          Step into and immerse yourself in an inviting ambiance that seamlessly combines modern elegance with a touch of [your restaurant's theme or style]. Whether you're here for an intimate dinner, a casual lunch, or a special celebration, our attentive staff is dedicated to ensuring your experience is nothing short of exceptional.
          </p>
        </div>
        <div class="about-img">
    ...
    <section id="food">
      <h2 style ="margin-bottom: 20px;">Types of food</h2>
      ...
      <div class="food-menu-container container">
        <div class="food-menu-item">
          ...
          <div class="food-description">
            <h2 class="food-titile">Avocado salad</h2>
            <p>
        ...
        <div class="food-menu-item">
          ...
          <div class="food-description">
            <h2 class="food-titile">Cereal Bowl</h2>
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Non,
              quae.
            </p>
        ...
        <div class="food-menu-item">
          ...
          <div class="food-description">
            <h2 class="food-titile">Greens</h2>
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Non,
              quae.
            </p>
        ...
        <div class="food-menu-item">
          ...
          <div class="food-description">
            <h2 class="food-titile">Diet meal</h2>
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Non,
              quae.
            </p>
        ...
        <div class="food-menu-item">
          ...
          <div class="food-description">
            <h2 class="food-titile">Snacks</h2>
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Non,
              quae.
            </p>
        ...
        <div class="food-menu-item">
          ...
          <div class="food-description">
            <h2 class="food-titile">Fruit Salad</h2>
            <p>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Non,
              quae.
            </p>
    ...
    <section id="testimonials">
      <h2 class="testimonial-title">Customers Review</h2>
